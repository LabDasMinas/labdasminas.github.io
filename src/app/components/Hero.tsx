...
export default function Hero(){
    ...
    <div>
        ...
        <ImageG src="/header_pink.svg" fill={true} alt="" className="object-cover object-bottom z-1 -mt-16"/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 pb-32 md:p-2 lg:p-16 2xl:pb-32 z-10">
                ...
                <div className="lg:col-span-3 w-full flex justify-center">
                    <ImageG className="absolute right-0 transform -translate-y-[30%] lg:-translate-y-[80%] 2xl:-translate-y-[60%] h-[210px] lg:h-[550px] w-fit" src="/dinaFinal.png" height={200} width={500} alt=""/>
                </div>
